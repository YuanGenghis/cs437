...
parser.add_argument("-n", "--thingName", action="store", dest="thingName", default="vehicle1", help="Targeted thing name")
...
if args.mode == 'both' or args.mode == 'subscribe':
    myAWSIoTMQTTClient.subscribe("max/co2/2", 0, None)
time.sleep(2)

vehicle_data = json.loads(open('./vehicle1.json').read())
    ...
    if args.mode == 'both' or args.mode == 'publish':
        if loopCount == 0:
            for i in range(len(vehicle_co2_json)):
                ...
                myAWSIoTMQTTClient.publish("max/co2/1/trigger", messageJson, 0)
                print('Published')
